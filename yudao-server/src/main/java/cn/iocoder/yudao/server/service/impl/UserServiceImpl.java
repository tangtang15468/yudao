...
import cn.iocoder.yudao.server.vo.OnlineTerminalVO;
import cn.iocoder.yudao.server.vo.UserVO;
...
public class UserServiceImpl extends ServiceImpl<ImUserMapper, User> implements IUserService {
